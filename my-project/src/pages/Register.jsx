...
const Register = () => {
  ...
  const { register, isAuthenticated, user, logout } = useAuthStore();
  ...
  return (
    <div className={`min-h-screen bg-white safe-area-inset-bottom overflow-x-hidden w-full flex flex-col transition-all duration-300 ${isSidebarOpen ? 'md:ml-80 md:w-[calc(100%-20rem)]' : 'md:w-full'}`}>
      ...
      <div className="flex-1 flex items-center justify-center py-6 px-4">
        <div className="w-full max-w-lg">
          <div className="bg-white p-6 md:p-8">
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">Create Account</h1>
            <p className="text-gray-600 mb-6 text-base">Sign up to get started with VINTAGE BEAUTY®</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-gray-400 focus:border-gray-400 transition-all text-base bg-white"
              ...
              <button
                type="submit"
                className="w-full bg-black text-white py-3 px-8 rounded-md font-semibold text-base hover:bg-gray-800 transition-all duration-200 uppercase tracking-wide"
              >
                Sign Up
              </button>
            </form>

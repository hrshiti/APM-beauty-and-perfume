  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20 md:pb-0 flex flex-col">
      <div className="flex-1 container mx-auto px-3 md:px-4 py-4 md:py-6 md:py-8 max-w-full overflow-x-hidden">
        <h1 className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-800 mb-4 md:mb-6">Shopping Cart</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-sm p-3 md:p-4 lg:p-6">
              ...
              <div className="mt-3 md:mt-4 pt-3 md:pt-4 border-t flex flex-col sm:flex-row justify-between gap-2 sm:gap-0">
                <Link
                  to="/shop-all"
          ...
          <div className="lg:col-span-1 mt-4 lg:mt-0">
            <div className="bg-white rounded-lg shadow-sm p-4 md:p-6 sticky top-20">
              <h2 className="text-lg md:text-xl font-bold text-gray-800 mb-3 md:mb-4">Order Summary</h2>
              ...
              <button
                ...
                className="w-full bg-black text-white py-2.5 md:py-3 rounded-lg font-semibold text-sm md:text-base hover:bg-gray-800 transition-colors mb-2 md:mb-3"
              >
                PROCEED TO CHECKOUT
              </button>
              ...
              <Link
                to="/crazy-deals"
                className="block text-center text-xs md:text-sm text-purple-600 hover:text-purple-700 font-medium"
              >
                View Deals & Offers
              </Link>
            </div>

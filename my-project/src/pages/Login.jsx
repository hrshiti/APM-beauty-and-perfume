      ...
      <div className="flex-1 flex items-center justify-center py-6 px-4">
        <div className="w-full max-w-lg">
          <div className="bg-white p-6 md:p-8">
            {/* Title */}
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4">Login</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {/* Sign In Button and Return to Store */}
              <div className="flex items-center justify-between gap-4 pt-2">
                <button
                  type="submit"
                  className="bg-black text-white py-3 px-8 rounded-md font-semibold text-base hover:bg-gray-800 transition-all duration-200 uppercase tracking-wide"
                >
                  SIGN IN
                </button>
                <Link 

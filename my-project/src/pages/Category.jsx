    ...
    <div className={`min-h-screen bg-gray-50 pb-20 md:pb-0 safe-area-inset-bottom overflow-x-hidden w-full flex flex-col transition-all duration-300 ${isSidebarOpen ? 'md:ml-80 md:w-[calc(100%-20rem)]' : 'md:w-full'}`}>
      ...
      <div className="flex-1 container mx-auto px-3 md:px-4 py-4 md:py-6 max-w-full overflow-x-hidden">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4 md:mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="px-3 md:px-4 py-1.5 md:py-2 text-sm md:text-base border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500"
            >
        ...
        {loading ? (
          ...
          <div className="text-center py-8 md:py-12">
            <p className="text-gray-600 text-base md:text-lg mb-2 md:mb-4">No products found in this category</p>
          </div>
        ) : (
          <>

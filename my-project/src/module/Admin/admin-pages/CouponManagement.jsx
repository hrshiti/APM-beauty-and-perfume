            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {coupons.length === 0 ? (
                ...
                coupons.map((coupon) => {
                  ...
                  const isUsedUp = coupon.usedCount >= (coupon.usageLimit || coupon.maxUses);
                  ...
                  return (
                    <tr key={coupon._id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className="text-sm text-gray-900">
                          {coupon.usedCount || 0} / {coupon.usageLimit || coupon.maxUses || 0}
                        </span>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className="text-sm text-gray-900">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className={`text-sm ${
                          ...
                          {formatDate(coupon.endDate || coupon.validUntil)}
                        </span>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">

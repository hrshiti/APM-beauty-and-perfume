...
const CustomerSupport = () => {
  ...
  const fetchSupportData = async () => {
    try {
      ...
      const [queriesResponse, ticketsResponse] = await Promise.all([
        adminService.getSupportQueries(),
  ...
  const handleQueryResponse = async () => {
    ...
    try {
      ...
      const response = await adminService.addQueryResponse(selectedQuery._id, {
  ...
  const handleTicketMessage = async () => {
    ...
    try {
      ...
      const response = await adminService.addTicketMessage(selectedTicket._id, {
  ...
  const handleQueryStatusChange = async (queryId, newStatus) => {
    try {
      const response = await adminService.updateQueryStatus(queryId, { status: newStatus });

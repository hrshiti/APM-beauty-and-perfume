...
const OrderSuccess = () => {
  ...
  const { orderId, orderItems, totalPrice, shipping, discount, finalTotal, paymentMethod, couponCode, deliveryAddress } = orderData;
          ...
          <div className="space-y-3 md:space-y-4">
            ...
            <div className="flex justify-between items-center pb-3 border-b border-gray-800">
              ...
              <span className="text-[#D4AF37] font-semibold text-sm md:text-base capitalize">
                {paymentMethod === 'card' ? 'Card' : paymentMethod === 'upi' ? 'UPI' : 'Cash on Delivery'}
              </span>
            </div>
